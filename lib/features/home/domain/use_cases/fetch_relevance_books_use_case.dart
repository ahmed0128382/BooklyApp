...
class FetchRelevanceBooksUseCase extends UseCase<List<BookEntity>> {
  final HomeRepo homeRepo;
  final String category;
  FetchRelevanceBooksUseCase(this.category, {required this.homeRepo});

  @override
  Future<Either<Failure, List<BookEntity>>> call() async {
    return await homeRepo.fetchRelevanceBooks(category: category);
  }
}
